...
export class PrismaTournamentRepository implements TournamentRepository {
  ...
  private toRow(rec: TournamentRecord) {
    return {
      ...
      meta: {
        ...
        organizerId: rec.organizerId ?? null,
        organizerName: rec.organizerName ?? null,
        groupSize: rec.groupSize ?? null,
        advancePerGroup: rec.advancePerGroup ?? null,
  ...
  private fromRow(r: any): TournamentRecord {
    ...
    return {
      ...
      organizerName: m.organizerName ?? undefined,
      groupSize: m.groupSize ?? undefined,
      advancePerGroup: m.advancePerGroup ?? undefined,
      heldFees: m.heldFees ?? [],
