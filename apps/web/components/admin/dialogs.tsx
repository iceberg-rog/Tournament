...
const ACTION_DESC: Partial<Record<TournamentAction, string>> = {
  ...
  delete: 'تورنومنت به بایگانی منتقل می‌شود و هنوز برای همیشه پاک نمی‌شود. از فیلترِ وضعیت «بایگانی» می‌توانی آن را پیدا کرده و به‌طورِ دائمی حذف کنی.',
  delete_permanent: 'این تورنومنت برای همیشه از سیستم حذف می‌شود. این عمل برگشت‌ناپذیر است.',
};
